...
class ImageToCSV:
    __IMAGE_PATH = 'C:\data\\animal\\'
    __RESIZED_IMAGE_PATH = __IMAGE_PATH + 'images\\'
    __DATA_PATH = 'C:\data\\animal\\'
    __LABEL_PATH = 'C:\\data\\animal\\csv\\animal_labels.csv'
    ...
    def _setLabel(self):
        file = open(self.__LABEL_PATH, mode='r')
    ...
    def _rgb2gray(self, rgb, type):
        ...
        if type == 'png':
            gray = 255 * (0.2126 * r + 0.7152 * g + 0.0722 * b)   # png는 0~1의 값을 가진다. 채널 3개를 하나로 줄여주는 공식! 이대로 쓰면 된다.
        elif type == 'jpg':
            gray = 0.2126 * r + 0.7152 * g + 0.0722 * b           # jpg는 0~255의 값을 가지고 있음
